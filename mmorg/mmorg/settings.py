"""
Django settings for mmorg project.
...
SECRET_KEY = 'django-insecure--&j=t4x$93zt2o^%o=r($tbb9&^7ply504bh*m+z(jkxyp^m*x'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'libraries': {
                'my_templatetag': 'appcore.templatetags.custom_tags',
...
WSGI_APPLICATION = 'mmorg.wsgi.application'
